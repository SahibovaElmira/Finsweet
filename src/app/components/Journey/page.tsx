  ...
  return (
    <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 justify-center">
      <div className="text-center">
        <h1 className="font-inter text-2xl font-bold leading-9 tracking-normal text-blue-700 dark:text-white mb-4">
          2023-cü ildə Youtube kanalımda olan mövzular
        </h1>
        <p className="font-inter text-base font-bold leading-7 tracking-normal text-justify  text-gray-600 dark:text-gray-300">
      ...
      <div className="text-center">
        ...
        <p className="font-inter text-base font-normal leading-7 tracking-normal text-justify  text-gray-600 dark:text-gray-300">
